...
imwrite(identity_image, './Submarine/identity_image.jpg', 'quality', 95);
...
imwrite(blur_image, './Submarine/blur_image.jpg', 'quality', 95);
...
imwrite(large_blur_image, './Submarine/large_blur_image.jpg', 'quality', 95);
...
imwrite(sobel_image + 0.5, './Submarine/sobel_image.jpg', 'quality', 95);
...
imwrite(laplacian_image + 0.5, './Submarine/laplacian_image.jpg', 'quality', 95);

%% High pass "filter" alternative
high_pass_image = test_image - blur_image; %simply subtract the low frequency content

figure(7); imshow(high_pass_image + 0.5);
imwrite(high_pass_image + 0.5, './Submarine/high_pass_image.jpg', 'quality', 95);
toc
%by James Hays