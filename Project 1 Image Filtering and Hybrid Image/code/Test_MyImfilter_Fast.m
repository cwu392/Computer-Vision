...
tic;
%% Setup
test_image = im2single(imread('../data/einstein.bmp'));
...
subplot(1,6,1); imshow(identity_filter+0.5);
subplot(1,6,2); imshow(blur_filter+0.5);
subplot(1,6,3); imshow(large_blur_filter+0.5);
