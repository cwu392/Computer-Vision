...
tic;
%% Setup
test_image = im2single(imread('../data/plane.bmp'));
...
imwrite(identity_image, './Plane/identity_image.jpg', 'quality', 95);
...
imwrite(blur_image, './Plane/blur_image.jpg', 'quality', 95);
...
imwrite(large_blur_image, './Plane/large_blur_image.jpg', 'quality', 95);
...
imwrite(sobel_image + 0.5, './Plane/sobel_image.jpg', 'quality', 95);
...
imwrite(laplacian_image + 0.5, './Plane/laplacian_image.jpg', 'quality', 95);

%% High pass "filter" alternative
high_pass_image = test_image - blur_image; %simply subtract the low frequency content

figure(7); imshow(high_pass_image + 0.5);
imwrite(high_pass_image + 0.5, './Plane/high_pass_image.jpg', 'quality', 95);
toc
%by James Hays