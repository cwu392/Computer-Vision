...
tic;
%% Setup
test_image = im2single(imread('../data/bird.bmp'));
...
imwrite(identity_image, './Bird/identity_image.jpg', 'quality', 95);
...
imwrite(blur_image, './Bird/blur_image.jpg', 'quality', 95);
...
imwrite(large_blur_image, './Bird/large_blur_image.jpg', 'quality', 95);
...
imwrite(sobel_image + 0.5, './Bird/sobel_image.jpg', 'quality', 95);
...
imwrite(laplacian_image + 0.5, './Bird/laplacian_image.jpg', 'quality', 95);

%% High pass "filter" alternative
high_pass_image = test_image - blur_image; %simply subtract the low frequency content

figure(7); imshow(high_pass_image + 0.5);
imwrite(high_pass_image + 0.5, './Bird/high_pass_image.jpg', 'quality', 95);
toc
%by James Hays