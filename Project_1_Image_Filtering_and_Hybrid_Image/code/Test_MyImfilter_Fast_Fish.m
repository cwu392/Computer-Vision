...
tic;
%% Setup
test_image = im2single(imread('../data/fish.bmp'));
...
imwrite(identity_image, './Fish/identity_image.jpg', 'quality', 95);
...
imwrite(blur_image, './Fish/blur_image.jpg', 'quality', 95);
...
imwrite(large_blur_image, './Fish/large_blur_image.jpg', 'quality', 95);
...
imwrite(sobel_image + 0.5, './Fish/sobel_image.jpg', 'quality', 95);
...
imwrite(laplacian_image + 0.5, './Fish/laplacian_image.jpg', 'quality', 95);

%% High pass "filter" alternative
high_pass_image = test_image - blur_image; %simply subtract the low frequency content

figure(7); imshow(high_pass_image + 0.5);
imwrite(high_pass_image + 0.5, './Fish/high_pass_image.jpg', 'quality', 95);
toc
%by James Hays