...
for i=1:5
    for j=1:5
            ...
            imwrite(hybrid_image,sprintf('../html/Hybrid/Einstein_Marilyn/Hybrid_%d_%d.jpg',i,j), 'quality', 95);
            imwrite(imresize(hybrid_image,0.5^4,'bilinear'),sprintf('../html/Hybrid/Einstein_Marilyn/Hybrid_Small_%d_%d.jpg',i,j), 'quality', 95);
...
for i=1:5
    for j=1:5
        if S_total(i,j)==S_min
            ...
            high_frequencies = image2-imfilter(image2, filter_high);
            hybrid_image = low_frequencies+high_frequencies;
            imwrite(hybrid_image,sprintf('../html/Hybrid/Best/Einstein_Marilyn_Hybrid_%d_%d.jpg',i,j), 'quality', 95);
            vis = vis_hybrid_image(hybrid_image);
            imwrite(vis, sprintf('../html/Hybrid/Best/Einstein_Marilyn_Hybrid_VIS_%d_%d.jpg',i,j), 'quality', 95);
        end
    end
end
